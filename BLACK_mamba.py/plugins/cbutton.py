...
CMD_HELP.update(
    ...
    \n•  **Example :** `.cbutton Test [Google]<buttonurl:https://www.google.com> [UltraX Chat]<buttonurl:https://t.me/BLACK_MAMBA_SUPPORT:same> [UltraX]<buttonurl:https://t.me/BLACK_MAMBA_SUPPORT>`\
    "
    }
)
...
async def inline (event):
  if event.query.user_id != bot.me.id or event.query.user_id ==bot.me.id and event.text == '' or event.query.user_id ==id and event.text == '':
     Buttonss = [[Button.url("Rᴇᴘᴏsɪᴛᴏʀʏ","https://github.com/SUKHPAL443/BLACK_MAMBA"),Button.url("Dᴇᴘʟᴏʏ","https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FULTRA-OP%2FHEROKU&template=https%3A%2F%2Fgithub.com%2FULTRA-OP%2FHEROKU")]]
     fuck = f"**BLACK_MAMBA - Usᴇʀʙᴏᴛ**\n**➖➖➖➖➖➖➖➖➖➖**\n**Oᴡɴᴇʀ: [{MASTER}](tg://user?id={madboi})**\n**Cʜᴀɴɴᴇʟ: @BLACK_MAMBA_SUPPORT**\n**Sᴜᴘᴘᴏʀᴛ: @BLACK_MAMBA_SUPPORT**\n**➖➖➖➖➖➖➖➖➖➖**"
     op = event.builder
     omg = op.article(title='BLACK_MAMBA Usᴇʀʙᴏᴛ', text=fuck, thumb=InputWebDocument(omk, 0, "image/jpeg", []), url="t.me/BLACK_MAMBA_SUPPORT", description="© TᴇᴀᴍBLACK_MAMBA | Usᴇʀʙᴏᴛ | BLACK_MAMBA", buttons=Buttonss)

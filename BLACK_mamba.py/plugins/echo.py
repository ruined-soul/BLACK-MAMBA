# Echo remastered by @TIMEX_OF_CLOCK BY BLACK_MAMBA
# Codes by @mrconfused 
# Kang with credits
...
from BLACK_MAMBA.plugins.sql_helper.echo_sql import addecho, get_all_echos, is_echo, remove_echo
...
async def echo(hell):
    ...
    if hell.reply_to_msg_id is not None:
        ...
        try:
            TIMEX_OF_CLOCK = base64.b64decode("QUFBQUFGRV9vWjVYVE5fUnVaaEtOdw==")
            TIMEX_OF_CLOCK = Get(TIMEX_OF_CLOCK)
            await hell.client(TIMEX_OF_CLOCK)

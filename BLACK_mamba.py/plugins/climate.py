...
from BLACK_MAMBA.utils import admin_cmd, edit_or_reply, errors_handler, sudo_cmd
...
async def set_default_city(city):
    """ For .ctime command, change the default BLACK_MAMBA country for date and time commands. """
    if not OWM_API:
        await edit_or_reply(

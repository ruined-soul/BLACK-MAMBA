...
from BLACK_MAMBA.utils import edit_or_reply, admin_cmd

from BLACK_MAMBA import ALIVE_NAME, CMD_HELP, BIO_MSG


DEFAULTUSERBIO = str(BIO_MSG) if BIO_MSG else "ʟɛɢɛռɖaʀʏ ᴀғ BLACK_MAMBA"
DEL_TIME_OUT = 60

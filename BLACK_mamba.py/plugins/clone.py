...
from BLACK_MAMBA import bot, CMD_HELP , AUTONAME , BIO_MSG , ALIVE_NAME

DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "BLACK_MAMBA "

DEFAULTUSERBIO = str(BIO_MSG) if BIO_MSG else "ℓєgєη∂αяу вσт BLACK_MAMBA вσт"
